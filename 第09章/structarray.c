...
int main() {
  struct SEISEKI myclass[STUDENTNO] = {"田中", 80, 80, 55, "佐藤", 75,  90, 70,
                                       "太田", 50, 45, 30, "鈴木", 100, 55, 90,
                                       "加藤", 60, 85, 35};
  int i, sum0 = 0, sum1[SUBJECTNO], sum2[STUDENTNO];

  for (i = 0; i < SUBJECTNO; i++) sum1[1] = 0;
  ...
  drawline();
  printf("%6s %6.1f %6.1f %6.1f %6.1f\n", "平均", (double)sum1[0] / STUDENTNO,
         (double)sum1[1] / STUDENTNO, (double)sum1[2] / STUDENTNO,
